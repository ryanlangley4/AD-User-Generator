...
$ou="OU=LANDING,DC=TEST,DC=LOCAL"
$principlename = "@TEST.LOCAL"
...
echo "Status,Date,SamAccountName,Password,FirstName,LastName,DisplayName,City,Phone" >> $log_path
